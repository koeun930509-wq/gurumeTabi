    ...
    <div className="min-h-full flex flex-col">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <h1 className="text-[#fff] font-bold text-3xl text-center px-6 translate-y-8 md:translate-y-4">{restaurant.name}</h1>
        </div>
        <button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-6 inline-flex items-center gap-1.5 bg-white/80 backdrop-blur text-xs font-normal text-gray-700 rounded-full px-2.5 py-1 md:px-4 md:py-2 shadow-md hover:text-brand-navy transition-colors cursor-pointer"
        >
