...
- ~~핫페퍼 그루메 API 보강~~: 2026-08-18 완료 — `enrich-hotpepper`로 영업시간/정휴일/예산대/카드결제/URL을 보강(1,970곳 중 1,589곳 매칭). 다만 UI에는 아직 노출하지 않음(DB 컬럼만 채워진 상태, 상세페이지에 표시할지는 별도 논의 필요)
- 구글 소셜 로그인
